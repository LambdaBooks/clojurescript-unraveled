...
Процес інсталяції _leiningen_ доволі простий. Виконайте наступні кроки:
...
Далі наведемо коротке пояснення властивостей, що мають значення у контексті _ClojureScript_:

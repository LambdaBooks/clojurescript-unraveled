...
Відкрита книга про ClojureScript. Читати оригінальну онлайн–версію можна [тут](http://funcool.github.io/clojurescript-unraveled/). Електронна версія оригінальної книги ( у форматах `epub` та `mobi`) доступна [на Leanpub](http://leanpub.com/clojurescript-unraveled), де ви можете підтримати нас або купити авторам пива.
...
- детальне керівництво до компілятора ClojureScript та інструментів довкола нього;
